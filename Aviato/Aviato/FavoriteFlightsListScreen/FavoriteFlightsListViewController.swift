...
protocol IFavoriteFlightsListViewController: AnyObject {
    ...
    func showFlyght(flyghtVC: FlightCardViewController)
}

class FavoriteFlightsListViewController: UIViewController, IFavoriteFlightsListViewController {
...
extension FavoriteFlightsListViewController: UITableViewDelegate {
...
extension FavoriteFlightsListViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let flyghtsList: [FlyghtInfoDataModel] = presenter.getFlyghts() {
            if indexPath.row < flyghtsList.count {
                ...
                cell.departireTimeLabel.text = "\(RootViewController.labels!.favoriteCellDepartureDate)  \(flyghtsList[indexPath.row].departureDate)"
            }
        }
        return cell
    }
